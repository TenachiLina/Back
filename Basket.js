...
app.get("/basket", (req, res) => {
    const q = "SELECT commande.*, produits.*, commande.Quantite AS Quantity FROM commande JOIN produits ON commande.produits_IdProd = produits.IdProd";
    db.query(q, (err, data) => {
...
app.post('/commande', (req, res) => {
    ...
    db.query(
        "INSERT INTO commande(produits_IdProd, utilisateur_IdUtilisateur, Quantite) VALUES (?, 25, ?)",
